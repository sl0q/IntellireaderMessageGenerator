...
MainFrame::MainFrame(const wxString &title) : wxFrame(nullptr, wxID_ANY, title)
{
    ...
    this->inputPathTC = new wxTextCtrl(panel, wxID_ANY, "/home/inf/Projects/message_creator_window/input/serializing_misc.json", wxPoint(50, 50), wxSize(300, -1));

    wxStaticText *outputPathST = new wxStaticText(panel, wxID_ANY, "Output file path:", wxPoint(50, 75), wxDefaultSize);
    this->outputPathTC = new wxTextCtrl(panel, wxID_ANY, "/home/inf/Projects/message_creator_window/output/output_misc_messages.txt", wxPoint(50, 100), wxSize(300, -1));
